...
public class BookTest {
    ...
    public void shouldCheckIfGettersOfBookObjectAreReturningRightInformation(){
        ...
        Assert.assertEquals(2, book.getAuthors().toArray().length);
        Assert.assertEquals(3, book.getCategories().toArray().length);
        ...
        Assert.assertTrue(Double.compare(10, book.getNoOfCopies()) == 0);
